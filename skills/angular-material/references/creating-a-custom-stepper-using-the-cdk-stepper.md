...
> Fonte: [documentação oficial](https://material.angular.dev/guide/creating-a-custom-stepper-using-the-cdk-stepper) — derivado de [`angular/components`](https://github.com/angular/components) (21.0.2), licença MIT. Ver NOTICE.
...
> _(exemplo `cdk-custom-stepper-without-form` não encontrado no upstream)_

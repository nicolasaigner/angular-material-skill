...
> Source: [official documentation](https://material.angular.dev/guide/creating-a-custom-stepper-using-the-cdk-stepper) — derived from [`angular/components`](https://github.com/angular/components) (21.0.2), MIT license. See NOTICE.
...
> _(example `cdk-custom-stepper-without-form` not found upstream)_

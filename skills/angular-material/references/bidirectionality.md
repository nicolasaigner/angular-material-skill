...
> Fonte: [documentação oficial](https://material.angular.dev/guide/bidirectionality) — derivado de [`angular/components`](https://github.com/angular/components) (21.0.2), licença MIT. Ver NOTICE.

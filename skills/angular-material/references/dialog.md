...
> Source: [official documentation](https://material.angular.dev/components/dialog/overview) — derived from [`angular/components`](https://github.com/angular/components) (v22.0.5), MIT license. See NOTICE.
...
#### Example: `dialog-from-menu` — `dialog-from-menu-example.ts` (region `focus-restoration`)

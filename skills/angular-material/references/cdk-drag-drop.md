...
> Fonte: [documentação oficial](https://material.angular.dev/cdk/drag-drop/overview) — derivado de [`angular/components`](https://github.com/angular/components) (21.0.2), licença MIT. Ver NOTICE.
...
#### Exemplo: `cdk-drag-drop-overview`
...
#### Exemplo: `cdk-drag-drop-connected-sorting`
...
#### Exemplo: `cdk-drag-drop-connected-sorting-group`
...
#### Exemplo: `cdk-drag-drop-custom-preview`
...
#### Exemplo: `cdk-drag-drop-custom-placeholder`
...
#### Exemplo: `cdk-drag-drop-horizontal-sorting`
...
#### Exemplo: `cdk-drag-drop-mixed-sorting`
...
#### Exemplo: `cdk-drag-drop-copy-list`
...
#### Exemplo: `cdk-drag-drop-boundary`
...
#### Exemplo: `cdk-drag-drop-axis-lock`
...
#### Exemplo: `cdk-drag-drop-root-element`
...
#### Exemplo: `cdk-drag-drop-enter-predicate`
...
#### Exemplo: `cdk-drag-drop-disabled`
...
#### Exemplo: `cdk-drag-drop-disabled-sorting`
...
#### Exemplo: `cdk-drag-drop-free-drag-position`
...
#### Exemplo: `cdk-drag-drop-sort-predicate`
...
operations.
#### Exemplo: `cdk-drag-drop-scrollable`

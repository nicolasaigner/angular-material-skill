...
> Source: [official documentation](https://material.angular.dev/components/autocomplete/overview) — derived from [`angular/components`](https://github.com/angular/components) (v22.0.4), MIT license. See NOTICE.
...
#### Example: `autocomplete-simple` — `autocomplete-simple-example.html` (region `mat-autocomplete`)
...
#### Example: `autocomplete-simple` — `autocomplete-simple-example.html` (region `input`)
...
#### Example: `autocomplete-optgroup` — `autocomplete-optgroup-example.html` (region `mat-autocomplete`)

...
> Source: [official documentation](https://material.angular.dev/guide/getting-started) — derived from [`angular/components`](https://github.com/angular/components) (v22.0.5), MIT license. See NOTICE.

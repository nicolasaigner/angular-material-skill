...
> Source: [official documentation](https://material.angular.dev/guide/using-component-harnesses) — derived from [`angular/components`](https://github.com/angular/components) (21.0.2), MIT license. See NOTICE.

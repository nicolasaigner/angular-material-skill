...
> Fonte: [documentação oficial](https://material.angular.dev/components/snack-bar/overview) — derivado de [`angular/components`](https://github.com/angular/components) (21.0.2), licença MIT. Ver NOTICE.

`MatSnackBar` is a service for displaying snack-bar notifications.

#### Exemplo: `snack-bar-overview`
...
#### Exemplo: `snack-bar-annotated-component`

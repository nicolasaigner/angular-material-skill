...
> Fonte: [documentação oficial](https://material.angular.dev/components/tree/overview) — derivado de [`angular/components`](https://github.com/angular/components) (21.0.2), licença MIT. Ver NOTICE.
...
#### Exemplo: `tree-flat-child-accessor-overview`
...
#### Exemplo: `tree-nested-child-accessor-overview`

...
> Fonte: [documentação oficial](https://material.angular.dev/components/slider/overview) — derivado de [`angular/components`](https://github.com/angular/components) (21.0.2), licença MIT. Ver NOTICE.

`<mat-slider>` allows for the selection of a value from a range via mouse, touch, or keyboard,
similar to `<input type="range">`.

#### Exemplo: `slider-overview`

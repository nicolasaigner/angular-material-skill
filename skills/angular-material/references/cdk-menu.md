...
> Source: [official documentation](https://material.angular.dev/cdk/menu/overview) — derived from [`angular/components`](https://github.com/angular/components) (v22.0.4), MIT license. See NOTICE.
...
#### Example: `cdk-menu-standalone-menu` — `cdk-menu-standalone-menu-example.html`
...
#### Example: `cdk-menu-standalone-menu` — `cdk-menu-standalone-menu-example.html` (region `trigger`)
...
#### Example: `cdk-menu-menubar` — `cdk-menu-menubar-example.html` (region `file-trigger`)
...
#### Example: `cdk-menu-inline` — `cdk-menu-inline-example.html`
...
#### Example: `cdk-menu-menubar` — `cdk-menu-menubar-example.html`
...
#### Example: `cdk-menu-context` — `cdk-menu-context-example.html`
...
#### Example: `cdk-menu-nested-context` — `cdk-menu-nested-context-example.html` (region `triggers`)
...
#### Example: `cdk-menu-standalone-stateful-menu` — `cdk-menu-standalone-stateful-menu-example.html` (region `reset-item`)
...
#### Example: `cdk-menu-standalone-stateful-menu` — `cdk-menu-standalone-stateful-menu-example.html` (region `bold-item`)
...
#### Example: `cdk-menu-standalone-stateful-menu` — `cdk-menu-standalone-stateful-menu-example.html` (region `size-items`)
...
#### Example: `cdk-menu-standalone-stateful-menu` — `cdk-menu-standalone-stateful-menu-example.html`

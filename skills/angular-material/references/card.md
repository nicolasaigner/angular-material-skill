...
> Source: [official documentation](https://material.angular.dev/components/card/overview) — derived from [`angular/components`](https://github.com/angular/components) (v22.0.4), MIT license. See NOTICE.

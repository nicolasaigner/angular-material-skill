...
> Source: [official documentation](https://material.angular.dev/cdk/tree/overview) — derived from [`angular/components`](https://github.com/angular/components) (21.0.2), MIT license. See NOTICE.
